      ...
      <div className="p-3 bg-white border-b flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-sm font-bold truncate">
            {currentConversation.counterparty.display_name || t('common:messaging.unknown_user')}
          </h2>
          <div className="flex items-center gap-1 text-xs text-gray-500">
            <span className="truncate">{currentConversation.listing.title}</span>
            <span>•</span>
            <span className="font-semibold text-blue-600">
              {currentConversation.listing.price_ron ? formatPrice(currentConversation.listing.price_ron) : t('common:listings.free')}
            </span>
          </div>
        </div>
