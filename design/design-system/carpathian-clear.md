...
- **Display & Headlines (Manrope):** Chosen for its geometric precision and excellent support for Romanian diacritics (*ș, ț, ă*). These should be tracked slightly tighter (-2%) for a modern, authoritative look.
